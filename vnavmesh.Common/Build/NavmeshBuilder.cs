...
public class NavmeshBuilder
{
    ...
    public void Build
    (
        Action<int>? onTileFinished = null
    )
    {
    ...
    public List<RcBuilderResult> BuildTiles
    (
        Action<int>? onTileFinished = null
    )
    {
    ...
    (
        IReadOnlyList<RcTelemetryTick> telemetry,
        long[]                         phaseTicks
    )
    {
    ...
    private static void LogBuildTelemetry
    (
        BuildTelemetrySummary telemetry
    )
    {
        ...
        if (detailPhase is { ShareOfPhaseTicks: >= 0.30 })
    ...
    private TileBuildResult[] BuildTileResults
    (
        bool         captureIntermediates,
    ...
    private List<RcBuilderResult> MergeBuiltTiles
    (
        IReadOnlyList<TileBuildResult> builtTiles,
        bool                           collectIntermediates
    )
    {
    ...
    private TileBuildResult BuildTileCore
    (
        int            x,
        int            z,
        TileBuildInput input,
        bool           captureIntermediates,
        Action<int>?   onTileProgress
    )
    {
        ...
        Action<RasterJob>? CreateRasterProgressReporter
        (
        ...
        (
            _tileSizeXVoxels,
            _tileSizeZVoxels,
            tileBoundsMin.ToRecast(),
            tileBoundsMax.ToRecast(),
            Settings.CellSize,
            Settings.CellHeight,
            _borderSizeVoxels
        );
    ...
    private void ApplyOffMeshConnections
    (
    ...
    private static long ElapsedTimeSpanTicks
    (
        long startTimestamp
    )
    ...
    private static int EstimateSpanWeight
    (
        int  primitiveCount,
        int  vertexCount,
        bool terrainLike,
    ...
    private void GetPrimitiveTileRange
    (
        PreparedTerrainGeometry.PrimitiveInfo primitiveInfo,
        out int                               minX,
        out int                               maxX,
        out int                               minZ,
        out int                               maxZ
