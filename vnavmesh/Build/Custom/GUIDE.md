...
| `VolumeThinWallStripNormalYThreshold` | 0.30 | 体积细墙剥离的法线判定阈值 |
| `VolumeThinWallStripMaxProjectedThickness` | 0.55 | 体积细墙允许的最大投影厚度 |
| `VolumeThinWallStripBaseRadius` | 0.75 | 体积细墙展开的基础半径下限（体积体素） |
| `VolumeThinWallStripExtraPadding` | 0.20 | 体积细墙展开的额外半径 |
