...
public static class NavmeshCustomizationRegistry
{
    ...
    static NavmeshCustomizationRegistry()
    {
        ...
        foreach (var t in Assembly
                          ...
                          .DefinedTypes
                          .Where(t => t.IsSubclassOf(baseType) && !t.IsAbstract && !t.IsDefined(typeof(CustomizationIgnoreAttribute), false))
                          .OrderBy
    ...
    public static NavmeshCustomization GetForTerritory
    (
        uint id
    ) => PerTerritory.GetValueOrDefault(id, Default);

    public static NavmeshCustomization GetForScene
    (
    ...
    (
        ...
        IReadOnlyDictionary<Type, SceneNavmeshCustomization> sceneInstances
    )
    {
