...
internal static class CustomizationDraftExporter
{
    ...
    )
    {
        ...
        Line(sb, 0, "using vnavmesh.Navigation.Custom.Attributes;");
        Line(sb);
        Line(sb, 0, "namespace vnavmesh.Navigation.Custom.Customizations.Territory.Generated;");
        Line(sb);
    ...
    )
    {
        ...
        Line(sb, 0, "using vnavmesh.Navigation.Custom.Abstractions;");
        if (context.HasSettings || context.NeedsSceneExtensions)
            Line(sb, 0, "using vnavmesh.Navigation.Custom.Extensions;");
