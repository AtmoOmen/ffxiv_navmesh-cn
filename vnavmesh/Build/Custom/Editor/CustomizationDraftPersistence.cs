...
)
{
    ...
    public CustomizationEditorTerritoryStore Load
    (
        uint territoryId
    )
    {
    ...
    public FileInfo GetStorePath
    (
        uint territoryId
    ) =>
        new(Path.Combine(rootDirectory.FullName, $"{territoryId:D4}.workspace.json"));

    private CustomizationEditorTerritoryStore? TryLoadLegacyDraft
    (
        uint territoryId
    )
    {
    ...
    private static CustomizationEditorTerritoryStore EnsureValid
    (
        CustomizationEditorTerritoryStore? store,
        uint                               territoryId
    )
    ...
    private static void EnsureWorkspaceValid
    (
    ...
    private static CustomizationEditorTerritoryStore CreateEmptyStore
    (
        uint territoryId
    )
    {
    ...
    private FileInfo GetLegacyPath
    (
        uint territoryId
    ) =>
