...
) : NavmeshCustomization
{
    ...
    public override NavmeshSettings GetBuildSettings
    (
        SceneDefinition definition
    )
    {
    ...
    protected internal override void ApplyBuildSettings
    (
        SceneDefinition definition,
    ...
    public override void CustomizeBuildProfile
    (
        SceneDefinition     definition,
