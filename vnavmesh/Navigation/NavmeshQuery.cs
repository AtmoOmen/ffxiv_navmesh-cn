...
public class NavmeshQuery
{
    ...
    private bool IsVoxelLikelyBelowSurface(ulong voxel, float minCandidateY)
    {
    ...
    private Vector3? FindPointOnFloorStrict(Vector3 p, float halfExtentXZ, bool allowUnreachable)
    {
