...
public partial class VoxelPathfind
{
    ...
    private const int    GUIDED_CORRIDOR_EARLY_ABORT_DESCENT_HARD_VISITED_THRESHOLD      = 150_000;
    private const int    GUIDED_CORRIDOR_EARLY_ABORT_DESCENT_STALL_WINDOW                = 80_000;
