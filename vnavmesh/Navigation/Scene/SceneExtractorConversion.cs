...
using CommonAabb = vnavmesh.Common.Numerics.Aabb;
using CommonMatrix4x3 = vnavmesh.Common.Numerics.Matrix4x3;

namespace vnavmesh.Navigation.Scene;

public static class SceneExtractorConversion
{
    public static BuildScene ToBuildScene(this SceneExtractor extractor)
    {
    ...
    private static CommonAabb Convert(AABB bounds) =>
        new(bounds.Min, bounds.Max);

    private static CommonMatrix4x3 Convert(Matrix4x3 matrix) =>
