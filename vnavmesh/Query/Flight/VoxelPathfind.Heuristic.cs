...
{
    private bool HasTraversableL1FaceTransition
    (
        ulong currentL1,
        ulong neighbourL1,
        int   dx,
    ...
    private bool ComputeL1FaceTransition
    (
        ulong currentL1,
        ulong neighbourL1,
        int   dx,
    ...
    private ushort GetReachableL1FacesFromEntry
    (
        ulong l1Voxel,
        int   entryFace
    )
    ...
    private ushort GetReachableL1FacesFromPoint
    (
        ulong   l1Voxel,
        ulong   actualVoxel,
        Vector3 point
    ...
    private bool ArePointsConnectedWithinL1
    (
        ulong   l1Voxel,
        ulong   fromVoxel,
        Vector3 fromPoint,
    ...
    private ulong BuildPackedL1FaceConnectivity
    (
        ulong l1Voxel
    )
    {
    ...
    private ushort FloodFillL1ReachableFaces
    (
        ulong  l1Voxel,
        ushort seedIndex
    ) => FloodFillL1Component(l1Voxel, seedIndex, null, null, out _);

    private bool FloodFillL1SeedConnectivity
    (
        ulong  l1Voxel,
        ushort fromSeedIndex,
        ushort toSeedIndex
    )
    {
    ...
    private ushort FloodFillL1Component
    (
        ulong    l1Voxel,
        ushort   seedIndex,
        bool[]?  visited,
        ushort?  targetSeedIndex,
    ...
    private bool TryResolveL1SeedIndex
    (
        ulong      l1Voxel,
        ulong      actualVoxel,
        Vector3    point,
        out ushort seedIndex
    )
    {
        seedIndex = 0;
    ...
    private ushort ResolvePointL2IndexWithinL1
    (
        ulong   l1Voxel,
        Vector3 point
    )
    ...
    private bool TryFindNearestEmptyL1SeedIndex
    (
        ulong      l1Voxel,
        Vector3    point,
        out ushort seedIndex
    ...
    private ulong ResolveRepresentativeL1Voxel
    (
        ulong   voxel,
    ...
    private bool IsVoxelInsidePathConstraint
    (
        ulong voxel
    )
    {
    ...
    private bool TryGetVoxelCorridorDistance
    (
        ulong   voxel,
        out int distance
    )
    ...
    private bool TryGetVoxelL1DistanceFloor
    (
        ulong     voxel,
        out float distance
    )
    ...
    private bool TryCreateGuidedCorridor
    (
        Vector3                  fromPos,
        Vector3                  toPos,
        out GuidedSearchCorridor corridor
    )
    {
        corridor = default;
    ...
    private float CalculateCorridorOverflowPenalty
    (
        Vector3 point
    )
    {
    ...
    private Vector3 ResolveVoxelCenter
    (
        ulong voxel
    )
    {
    ...
    private bool HasEmptyNeighbourInDirection
    (
        ulong voxel,
        int   dx,
        int   dy,
    ...
    private bool HasEmptyOnBorder
    (
        ulong       voxel,
        VolumeLevel levelDesc,
        int         level,
        int         dx,
        int         dy,
        int         dz
    ...
    private bool HasEmptyBorderWithSubdivisions
    (
        ulong voxel,
        int   dx,
        int   dy,
    ...
    private float ComputeLongRangeLateralHeuristic
    (
        Vector3 position,
        ulong   voxel
    )
    ...
    private bool HasDownwardOpening
    (
        ulong voxel
    )
    {
    ...
    private bool HasVerifiedTopEntry
    (
        ulong voxel
    )
    {
    ...
    private bool HasVerifiedVerticalAccessThroughFace
    (
        ulong voxel,
        bool  throughLowerFace
    )
    {
