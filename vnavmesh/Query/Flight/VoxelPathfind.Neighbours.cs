...
public partial class VoxelPathfind
{
    ...
    )
    {
        ...
        if (allowCoarseL1Stepping && !longRangeLateralBias.Enabled && l1Index != VoxelMap.INDEX_LEVEL_MASK)
        {
        ...
        if (!longRangeLateralBias.Enabled && l2Index != VoxelMap.INDEX_LEVEL_MASK)
        {
    ...
    private bool ShouldPreferCoarseDescentNeighbour
    (
        int dx,
        int dy,
        int dz
    ...
    private bool CanUsePreferredCoarseNeighbour
    (
        ulong voxel,
        int   dy
    )
    ...
    private void CollectBorderWithSubdivisions
    (
        ulong voxel,
        int   dx,
        int   dy,
    ...
    private void CollectBorderWithSubdivisionsL1Only
    (
        ulong voxel,
        int   dx,
        int   dy,
    ...
    private void AddNeighbourIfEmpty
    (
        ulong voxel
    )
    {
