...
{
    public static ushort ExtractL0Index
    (
        ulong voxel
    )
    {
    ...
    public static bool IsCoarseNeighbour
    (
        ulong voxel
    )
    {
    ...
    public static bool TryExtractL1Parent
    (
        ulong     voxel,
        out ulong l1Voxel
    )
    ...
    public static bool TryExtractL2IndexWithinL1
    (
        ulong      voxel,
        ulong      expectedL1,
        out ushort l2Index
    ...
    public static ushort GetPackedReachableL1Faces
    (
    ...
    public static ulong SetPackedReachableL1Faces
    (
        ulong  packedConnectivity,
        int    face,
        ushort reachableFaces
    )
    {
        var shift = face * 6;
