...
public partial class VoxelPathfind
{
    ...
    (
        ...
        int               maxSteps = DEFAULT_MAX_SEARCH_STEPS
    )
    {
    ...
    (
        ...
        Vector3                            fromPos,
        Vector3                            toPos,
        out List<(ulong voxel, Vector3 p)> path
    )
    {
    ...
    private bool ShouldUseShortRangeExploratoryHeuristic
    (
        Vector3 fromPos,
        Vector3 toPos
    )
    ...
    private int ResolveShortRangeFastSearchStepBudget
    (
        float distance
    )
    {
