...
public static class CurveApproxUtil
{
    ...
    public static IEnumerable<Vector2> Circle
    (
        Vector2 center,
        float   radius,
        float   maxError
    ...
    public static IEnumerable<Vector2> CircleArc
    (
        Vector2 center,
        float   radius,
        Angle   angleStart,
    ...
    public static IEnumerable<Vector2> CircleSector
    (
        Vector2 center,
        float   radius,
        Angle   angleStart,
    ...
    public static IEnumerable<Vector2> DonutSector
    (
        Vector2 center,
        float   innerRadius,
        float   outerRadius,
